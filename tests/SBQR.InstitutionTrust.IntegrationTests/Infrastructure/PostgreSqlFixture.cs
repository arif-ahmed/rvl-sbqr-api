...
/// PostgreSQL 16-alpine container for the entire test assembly. Mirrors
/// tests/SBQR.Tenancy.IntegrationTests/Infrastructure/PostgreSqlFixture.cs.
///
/// <para>
...
/// are the single source of truth; this fixture applies them to the
/// ephemeral container the way the external migration tool would.
/// </para>
/// </summary>
public sealed class PostgreSqlFixture : IAsyncLifetime
{
    ...
    private async Task ApplyCanonicalMigrationsAsync()
    {
        ...
        // Probe public.institution_keys — this module's
        // sentinel table (post 2026-09-09 consolidation; the legacy
        // institution_registries table no longer exists). The
        // trust-directory table lives in public per
        // db/migrations/005_institution_trust.sql.
        await using var probe = new NpgsqlCommand(
            "SELECT to_regclass('public.institution_keys')::text;", conn);
        ...
        if (result is null || result is DBNull)
        {
            throw new InvalidOperationException(
                ...
                "public.institution_keys on the test " +
                "container — the migration scripts are broken.");
        }
    }
